...
data class UserSettings(
    ...
    /**
     * Preferred body-weight display/entry unit (v20). Raw value of
     * [com.silverbp.android.core.WeightUnit] — "kg" (default, Taiwan mainstream)
     * or "lb". Storage is always canonical kg; this drives how values are shown
     * and the default unit when entering a reading (mirrors [glucoseUnit]).
     */
